...
            const user = req.user; // **CRITICAL**: Get the authenticated user from the request
            const signedUrl = await ApplicationService.getResumeSignedUrl(applicationId, user); // **CRITICAL**: Pass the user to the service
